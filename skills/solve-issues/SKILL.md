...
- Set `REV review`. The review task reads the branch and `DRAFT.md`, writes actionable external findings only to `REVIEW.md`, and edits no code. With no findings, it returns only the exact pass marker.
