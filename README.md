...
- `solve-issues`: triggered by "solve issues" or "building loops"; fetches open issues, determines internal/external mode, creates two visible ponytail Codex app threads per issue, and calls `$solve-issue` with a task packet.
