...
- `solve-issues`: triggered by "solve issues" or "building loops"; fetches open issues, determines internal/external mode, creates two ponytail threads per issue, and calls `$solve-issue` with a task packet.
